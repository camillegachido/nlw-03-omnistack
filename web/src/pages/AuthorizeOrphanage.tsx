...
import { FiPlus, FiXCircle, FiCheckCircle } from "react-icons/fi";
...
export default function CreateOrphanage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try{
      if(params.id){
        await apiWithToken.put('authorize-orphanage/'+params.id)
        ...
        <form className="create-orphanage-form" onSubmit={handleSubmit}>
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple type="file" id="image[]"></input>
            </div>
